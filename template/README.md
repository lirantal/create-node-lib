...
<p align="center">
  ...
  <a href="https://github.com/<%= username %>/<%= projectName %>/actions/workflows/ci.yml"><img src="https://github.com/<%= username %>/<%= projectName %>/actions/workflows/ci.yml/badge.svg?branch=main" alt="build"/></a>
